...
export function applyState(stateData) {
    ...
    Object.keys(inputs).forEach(key => {
        if (inputs[key] && stateData[key] !== undefined) inputs[key].value = stateData[key];
    });
...
export function updatePreview() {
    ...
    const staticQrCodeUrl = "[https://i.ibb.co/4RpHrqMH/FD.jpg](https://i.ibb.co/4RpHrqMH/FD.jpg)";
